                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="widget-category mb-30">
                            ...
                            <ul class="categories">
                                <li><a href="{{url('/shop')}}">Shoes & Bags</a></li>
                                <li><a href="{{url('/shop')}}">Blouses & Shirts</a></li>
                                <li><a href="{{url('/shop')}}">Dresses</a></li>
                                <li><a href="{{url('/shop')}}">Swimwear</a></li>
                                <li><a href="{{url('/shop')}}">Beauty</a></li>
                                <li><a href="{{url('/shop')}}">Jewelry & Watch</a></li>
                        ...
                        <div class="sidebar-widget price_range range mb-30">
                            ...
                            <a href="{{url('/shop')}}" class="btn btn-sm btn-default"><i class="fi-rs-filter mr-5"></i> Fillter</a>
                        </div>
